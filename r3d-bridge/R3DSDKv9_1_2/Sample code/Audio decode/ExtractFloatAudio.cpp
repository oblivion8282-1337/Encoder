...
int main(int argc, char * argv[])
{
	...
	audiobuffer[15] = 6;			// 6 = 32-bit IEEE floating point
	...
	for (size_t al = 0U; al < blocks; al++)
	{
		...
		clip->DecodeFloatAudioBlock(al, audiobuffer, &bufferSize);	// bufferSize gets updated
