...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "rb.outdir":              {"de": "Ordner wählen",               "en": "Choose folder"},
    "rb.adjacent":            {"de": "Neben Originalen",            "en": "Next to originals"},
    "chk.mirror_structure":   {"de": "Ordnerstruktur spiegeln",     "en": "Mirror folder structure"},
    "lbl.path_preview_example": {"de": "Beispiel.MOV",             "en": "Example.MOV"},
    # ── Widgets ────────────────────────────────────────────────────────────
    ...
    "toolbar.settings":   {"de": "Einstellungen",    "en": "Settings"},
    "dlg.settings_title": {"de": "Einstellungen",    "en": "Settings"},
    "dlg.braw_rewrap_title": {"de": "BRAW nicht unterstützt", "en": "BRAW not supported"},
    "dlg.braw_rewrap_msg":   {
        "de": "{n} BRAW-Datei(en) wurden übersprungen.\nBRAW kann nicht als Re-Wrap verarbeitet werden.\nBitte Proxy-Modus wählen.",
        "en": "{n} BRAW file(s) were skipped.\nBRAW cannot be processed as Re-Wrap.\nPlease select Proxy mode.",
    },
    # ── Job-Status ─────────────────────────────────────────────────────────
    ...
    "msg.restart_for_style": {
        "de": "Der Stil 'System-Standard' wird nach einem Neustart der App aktiv.",
        "en": "The 'System Default' style will be applied after restarting the app.",
    },
}
